...
class VistaEvento(ttk.Frame):
    ...
    def cargarComponentes(self):
        ...
        self.__lblTitulo = ttk.Label(self, text=self.__datos['TITULO'], font=('Ubuntu', '12', 'bold'), padding=5,
        ...
        self.__lblFecha = ttk.Label(self, text=self.__datos['FECHA'] + ' - ' + self.__datos['HORA'],
        ...
        self.__lblDura = ttk.Label(self, text=self.__datos['DURACION'], font=('Ubuntu', '11', 'bold'), padding=5,
                                   background=self.__gui.configTema['bgLabelText'])
        ...
        self.__lblImpor = ttk.Label(self, text=self.__datos['IMPORTANCIA'], font=('Ubuntu', '11', 'bold'), padding=5,
                                    background=self.__gui.configTema['bgLabelText'])
        ...
        self.__lblTag = ttk.Label(self, text=self.__datos['ETIQUETA'], font=('Ubuntu', '11', 'bold'), padding=5,
                                  background=self.__gui.configTema['bgLabelText'])
        ...
        self.__lblRecor = ttk.Label(self, text=self.__datos['RECORDATORIO'], style='lblName.TLabel', padding=5,
                                    background=self.__gui.configTema['bgLabelText'])
...
class NuevoEventoVista(ttk.Frame):
    ...
    def __cargarComponentes(self):
        ...
        # TITULO
        ttk.Label(self.__block1, font=('Ubuntu', '12', 'bold'), text="Título: ", justify='left', width=6).grid(column=0,
                                                                                                               row=0,
                                                                                                               columnspan=1,
                                                                                                               sticky=(
                                                                                                                   tk.W),
